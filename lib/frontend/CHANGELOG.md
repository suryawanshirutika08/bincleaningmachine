...
- Fix nav links ([#1501](https://github.com/tailwindlabs/tailwindui-issues/issues/1501))
...
- Fix smooth scroll when using nav bar ([#1456](https://github.com/tailwindlabs/tailwindui-issues/issues/1456))
